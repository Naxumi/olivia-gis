...
<section id="hero" class="bg-gradient-to-br from-green-600 to-emerald-700 dark:from-green-700 dark:to-emerald-800 text-white pt-20 pb-16 md:pt-28 md:pb-24">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="max-w-3xl mx-auto">
            <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight tracking-tight">
                Revolusi Pengelolaan Sampah: <span class="block sm:inline"><span id="typing-text-placeholder"></span><span class="typing-cursor">|</span></span>
            </h1>
            <p class="text-lg md:text-xl mb-10 text-emerald-100 dark:text-emerald-200 max-w-2xl mx-auto">
                Menghubungkan industri penghasil sampah dengan pengolah sampah melalui solusi GIS cerdas dan berkelanjutan.
        ...
        <div class="mt-12 md:mt-16">
            <img src="{{ asset('images/hero-waste-management.png') }}" alt="Platform B2B GIS untuk Pengelolaan Sampah" class="mx-auto rounded-lg shadow-2xl max-w-xs sm:max-w-sm md:max-w-md lg:max-w-xl xl:max-w-2xl transform hover:scale-105 transition-transform duration-500">
            {{-- Ganti 'hero-mockup.png' dengan gambar yang lebih relevan dengan tema sampah/daur ulang --}}
            <p class="text-xs text-emerald-200 dark:text-emerald-300 mt-2">Solusi digital untuk rantai pasok sampah yang efisien.</p>
        </div>
    </div>
</section>
