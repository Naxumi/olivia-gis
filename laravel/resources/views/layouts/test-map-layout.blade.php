...
<head>
    ...
    <title>{{ $title ?? 'Peta Interaktif - Platform Anda' }}</title>
...
<body class="font-sans antialiased text-gray-900 dark:text-gray-100 bg-gray-100 dark:bg-gray-900 h-screen w-screen overflow-hidden">
    {{ $slot }}
